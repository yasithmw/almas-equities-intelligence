...
// button. Enter sends, Shift+Enter breaks the line, exactly as it does in
// the product; the platform prints that as a hint under the box and this
// does not, because the client in the room is being shown what the thing
// answers, not taught its shortcuts.
  ...
  return (
    <div
      className={cn(
        ...
        // treatment at all. A keyboard user tabbing into the demo's primary
        // control has to see where they landed, so the whole box takes the
        // ring when anything inside it holds focus.
